...
export default function Services() {
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-auto hidden lg:block">
            <div className="inline-block">
              <button className="py-3 px-5 w-full text-slate-300 font-semibold border border-indigo-700 rounded-xl focus:ring focus:ring-indigo-300 bg-indigo-600  hover:bg-indigo-700 transition ease-in-out duration-200" type="button"><Link to="/Login" className="text-white">Try 14 Days Free Trial</Link></button>
            </div>
          </div>
  ...
  <div className="overflow-hidden pt-16">
    <div className="container px-4 mx-auto">
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          <div className="flex flex-wrap -m-2.5 mb-20">
            <div className="w-full md:w-auto p-2.5">
              <div className="block">
                <button className="py-4 px-6 w-full text-slate-50 font-semibold border border-indigo-700 rounded-xl focus:ring focus:ring-indigo-300 bg-indigo-600 hover:text-slate-50  transition ease-in-out duration-200" type="button" 
                ><Link to="/Login" className="text-white">Join Free for 30 Days</Link> </button>
              </div>
            </div>
            <div className="w-full md:w-auto p-2.5">
              <div className="block">
      ...
      >
        <section className="pt-14 pb-28 bg-[url('../image/tut4.jpg')] bg-opacity-100 overflow-hidden ">
          <div className="container px-4 mx-auto">
